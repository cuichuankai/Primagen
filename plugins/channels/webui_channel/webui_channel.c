...
"<style>"
"*{box-sizing:border-box}:root{--bg:#e8eef8;--bg-grad:#f6f8fd;--panel:#f4f7fdc9;--panel-2:#edf3fccf;--text:#0f172a;--muted:#5b6475;--line:#d6deea;--line-strong:#bcc8db;--table-head-bg:#e9eef7;--table-row-bg:#f7fafe;--primary:#4f6bff;--primary-soft:#e8edff;--accent:#10b981;--accent-soft:#ddfaf0;--glow:rgba(79,107,255,.22);--shadow:0 14px 36px rgba(30,41,59,.1)}html[data-theme='dark']{--bg:#0c1320;--bg-grad:#121a2c;--panel:#1a2438c9;--panel-2:#1f2a43cf;--text:#dbe4f6;--muted:#9aa8c2;--line:#33415e;--line-strong:#4a5c82;--table-head-bg:#25314c;--table-row-bg:#1b2438;--primary:#8a9bff;--primary-soft:#2a3558;--accent:#34d399;--accent-soft:#113d36;--glow:rgba(138,155,255,.26);--shadow:0 14px 34px rgba(0,0,0,.45)}body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif;margin:0;background:radial-gradient(900px 500px at 10% -20%,var(--glow),transparent 60%),radial-gradient(680px 460px at 95% 0%,color-mix(in srgb,var(--accent) 18%, transparent),transparent 62%),linear-gradient(140deg,var(--bg-grad),var(--bg));color:var(--text);position:relative;overflow:hidden}body::before{content:'';position:fixed;inset:-20% -15% auto auto;width:620px;height:620px;border-radius:50%;background:radial-gradient(circle,color-mix(in srgb,var(--primary) 24%, transparent),transparent 68%);filter:blur(18px);pointer-events:none;opacity:.6;animation:floatGlow 16s ease-in-out infinite alternate}"
".layout{display:flex;height:100vh;position:relative;z-index:1}.sidebar{width:240px;background:linear-gradient(180deg,color-mix(in srgb,var(--panel) 92%, transparent),var(--panel));backdrop-filter:blur(14px);border-right:1px solid color-mix(in srgb,var(--line) 82%, var(--primary));display:flex;flex-direction:column;transition:width .24s ease,box-shadow .2s ease;position:relative;box-shadow:inset -1px 0 0 color-mix(in srgb,var(--primary) 12%, transparent)}"
...
".content{flex:1;display:flex;flex-direction:column;min-width:0;height:100vh}.topbar{position:sticky;top:0;z-index:9;height:56px;display:flex;align-items:center;justify-content:space-between;padding:10px 18px;background:linear-gradient(90deg,color-mix(in srgb,var(--panel) 94%, transparent),var(--panel));backdrop-filter:blur(14px);border-bottom:1px solid color-mix(in srgb,var(--line) 85%, var(--primary));box-shadow:0 8px 24px rgba(15,23,42,.06)}"
...
".overview-hero{display:grid;grid-template-columns:1.4fr 1fr;gap:12px;margin-bottom:12px}.hero-panel{background:linear-gradient(140deg,color-mix(in srgb,var(--primary) 30%, var(--panel)),color-mix(in srgb,var(--accent) 10%, var(--panel)));border:1px solid color-mix(in srgb,var(--primary) 44%, var(--line));border-radius:16px;padding:16px;box-shadow:0 16px 34px color-mix(in srgb,var(--primary) 18%, rgba(30,41,59,.18));position:relative;overflow:hidden}.hero-panel::after{content:'';position:absolute;right:-34px;top:-42px;width:180px;height:180px;border-radius:50%;background:radial-gradient(circle,color-mix(in srgb,var(--accent) 38%, transparent),transparent 70%);pointer-events:none}.hero-title{font-size:20px;font-weight:700}.hero-sub{font-size:13px;color:var(--muted);margin-top:6px}.quick-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:14px}.quick-actions button{height:36px;padding:0 12px;border-radius:10px}.overview-kpi{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-bottom:12px}.kpi{background:var(--panel);border:1px solid color-mix(in srgb,var(--line) 84%, var(--accent));border-radius:14px;padding:12px}.kpi .k{font-size:12px;color:var(--muted)}.kpi .v{font-size:22px;font-weight:700;margin-top:4px}.chat-toolbar{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 18px;border-bottom:1px solid var(--line);background:var(--panel)}.chat-toolbar .toolbar-actions{display:flex;gap:8px}.chat-toolbar .toolbar-actions .secondary{height:34px;padding:0 12px;border-radius:9px}.config-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.field{display:flex;flex-direction:column;gap:6px}.field label{font-size:12px;color:var(--muted)}.status-hint{font-size:12px;color:var(--muted)}.status-hint.dirtyHint{color:#d97706}.status-hint.saved{color:#16a34a}.status-hint.error{color:#dc2626}.op-history{margin-top:12px}.op-history .list-kv{border-top:1px dashed var(--line)}@keyframes floatGlow{0%{transform:translate3d(0,0,0)}100%{transform:translate3d(-28px,20px,0)}}@keyframes riseIn{0%{opacity:0;transform:translateY(7px)}100%{opacity:1;transform:translateY(0)}}.view>*{animation:riseIn .36s ease both}.item.active,.subitem.active{box-shadow:0 8px 20px color-mix(in srgb,var(--primary) 22%, transparent)}"
